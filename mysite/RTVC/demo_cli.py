...
def maux(output_text,num):
    ...
    encoder.load_model("D:/RemindMe/django-remindme/mysite/trained model/encoder/saved_models/pretrained.pt")

    synthesizer = Synthesizer("D:/RemindMe/django-remindme/mysite/trained model/synthesizer/saved_models/logs-pretrained/taco_pretrained", low_mem=False)
   
    vocoder.load_model("D:/RemindMe/django-remindme/mysite/trained model/vocoder/saved_models/pretrained/pretrained.pt")
    ...
    in_fpath = Path("D:/RemindMe/django-remindme/mysite/trained model/sam_narration2.wav")
